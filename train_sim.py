    ...
    for i in range(5):
        ...
        for epoch in range(epochs):
            ...
            val_loss, val_acc, val_auroc, val_f1_score, val_precision, val_recall, val_ap = val_SRR(Model, criterion, val_loader,
                                                                                                device, epoch)
            val_msg = "ablation_Sim,the-%d-fold,epoch-%d, train_loss-%.4f, train_acc-%.4f, val_loss-%.4f, val_acc-%.4f, val_auroc-%.4f, val_f1_score-%.4f, val_prec-%.4f, val_rec-%.4f, val_ap-%.4f" % (
