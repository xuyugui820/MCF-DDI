...
from attention import Attention_Layern,CrossModalAttention
...
class GNN_Sim(nn.Module):
    ...
    def Fusion(self, sub, data, sim_ht):
        ...
        # sim = self.lin_sim(sim.float())#线性层（1024，1706）--》（1024，128）
        # 使用交叉注意力
        d_g1, sim_ht1 = self.Attention_Layern(d_g, sim_ht)
...
class Sim_Finger(nn.Module):
    ...
    def Fusion(self,finger, sim_ht):
        ...
        finger_c = finger
        finger1, sim1 = self.Attention_Layern(finger_c, sim_ht)
